...
class TableProcessor:
    ...
    def process_directory(self):
        ...
        for root, dirs, files in os.walk(self.download_folder):
            ...
            for filename in files:
                if filename.startswith("table_") and filename.endswith(".csv"):
                    ...
                    output_path = os.path.join(
                        self.output_directory, relative_path, filename
                    )
                    ...
                    try:
                        columns_original, rows_original = process_csv(
            ...
            additional_info_output_path = os.path.join(
                output_dir, "additional_info.json"
            )
        ...
        print(
            "Cantidad total de datasets descartados por error de encoding:",
            self.total_datasets_encoding_error,
        )
        print(
            "Cantidad total de datasets descartados por error de extensión:",
            self.total_datasets_extension_error,
        )
        print(
            "Cantidad total de datasets descartados por tamaño:",
            self.total_datasets_size_error,
        )
