...
"""
    ...
    def column_description_prompt(
        self, table, table_id, column_name, additional_info, few_shots_prompt_data
    ):
...
"""
    ...
    def generate_column_description(
        ...
        inputs = self.tokenizer(
            self.column_description_prompt(
                table, table_id, column_name, additional_info, few_shots_prompt_data
            ),
            return_tensors="pt",
        ).to(self.device)
