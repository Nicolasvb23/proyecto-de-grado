...
class CTA_Evaluator:
  ...
  def _evaluate(self, client_payload, _context={}):
    ...
    gt_ancestor = json.load(open("evaluation/cta_gt_ancestor.json"))
    gt_descendent = json.load(open("evaluation/cta_gt_descendent.json"))
        ...
        if col in cols:
            ...
            for gt_type in col_type[col].split():
                ...
                if annotation.lower() == gt_type.lower():
                    print("EXACT")
                    well_classificated = well_classificated + 1
                    score = 1.0
    ...
    print(well_classificated, "columnas se anotaron bien de ", len(annotated_cols))
